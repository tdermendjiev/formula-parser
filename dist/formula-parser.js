...
var Parser = function (_Emitter) {
  ...
  function Parser() {
    ...
    _this.parser.yy = {
      ...
      dbValue: function dbValue(database, table, column, row) {
        return _this._callDbValue(database, table, column, row);
      },
      dbArray: function dbArray(database, table, column) {
        return _this._callDbArray(database, table, column);
      }
    };
  ...
  Parser.prototype.parse = async function parse(expression) {
    var result = null;
    var error = null;
  ...
  Parser.prototype._callFunction = async function _callFunction(name) {
  ...
  Parser.prototype._callDbValue = function _callDbValue(database, table, column, row) {
    console.log("CALLING DB VALUE");
    var vv = 0;
    this.emit('callDbValue', { database: database, table: table, column: column, row: row }, function (_value) {
      vv = _value;
    });
    return vv;
  };

  Parser.prototype._callDbArray = function _callDbArray(database, table, column) {
    console.log("CALLING DB ARRAY");
    var vv = [];
    this.emit('callDbArray', { database: database, table: table, column: column }, function (_value) {
      vv = _value;
    });
    return vv;
  };
...
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,5],$V1=[1,8],$V2=[1,6],$V3=[1,7],$V4=[1,9],$V5=[1,15],$V6=[1,16],$V7=[1,17],$V8=[1,18],$V9=[1,14],$Va=[1,13],$Vb=[1,19],$Vc=[1,21],$Vd=[1,22],$Ve=[1,23],$Vf=[1,24],$Vg=[1,25],$Vh=[1,26],$Vi=[1,27],$Vj=[1,28],$Vk=[1,29],$Vl=[1,30],$Vm=[5,9,10,11,13,14,15,16,17,18,19,20,32,33],$Vn=[5,9,10,11,13,14,15,16,17,18,19,20,32,33,36],$Vo=[5,9,10,11,13,14,15,16,17,18,19,20,32,33,37],$Vp=[5,10,11,13,14,15,16,17,32,33],$Vq=[5,10,13,14,15,16,32,33],$Vr=[5,10,11,13,14,15,16,17,18,19,32,33],$Vs=[13,32,33];
...
case 39:
      ...
      this.$ = yy.dbValue($$[$0-6], $$[$0-4], $$[$0-2], $$[$0]);

break;
case 40:

      this.$ = yy.dbArray($$[$0-4], $$[$0-2], $$[$0]);
...
case 46:
      ...
      this.$ = yy.allFromTable($$[$0-2], $$[$0]);

break;
case 47:

      this.$ = yy.allFromTableColumn($$[$0-2], $$[$0]);

break;
case 48:

      this.$ = yy.allFromTableColumn($$[$0-2], $$[$0], $$[$0-4]);
...
table: [{2:12,3:1,4:2,6:3,7:4,8:$V0,11:$V1,12:$V2,17:$V3,21:$V4,23:10,24:11,25:$V5,26:$V6,27:$V7,29:$V8,30:$V9,34:$Va,38:$Vb},{1:[3]},{5:[1,20],9:$Vc,10:$Vd,11:$Ve,14:$Vf,15:$Vg,16:$Vh,17:$Vi,18:$Vj,19:$Vk,20:$Vl},o($Vm,[2,2],{36:[1,31]}),o($Vm,[2,3],{37:[1,32]}),o($Vm,[2,4]),{2:12,4:33,6:3,7:4,8:$V0,11:$V1,12:$V2,17:$V3,21:$V4,23:10,24:11,25:$V5,26:$V6,27:$V7,29:$V8,30:$V9,34:$Va,38:$Vb},{2:12,4:34,6:3,7:4,8:$V0,11:$V1,12:$V2,17:$V3,21:$V4,23:10,24:11,25:$V5,26:$V6,27:$V7,29:$V8,30:$V9,34:$Va,38:$Vb},{2:12,4:35,6:3,7:4,8:$V0,11:$V1,12:$V2,17:$V3,21:$V4,23:10,24:11,25:$V5,26:$V6,27:$V7,29:$V8,30:$V9,34:$Va,38:$Vb},{12:[1,36]},o($Vm,[2,23]),o($Vm,[2,24]),o($Vm,[2,25],{2:37,38:$Vb}),o($Vn,[2,45],{28:[1,39],35:[1,38]}),o($Vo,[2,50],{36:[1,40]}),o($Vm,[2,27],{28:[1,41]}),o($Vm,[2,28],{28:[1,42]}),o($Vm,[2,29],{28:[1,43]}),{28:[1,44]},o([5,9,10,11,13,14,15,16,17,18,19,20,32,33,38],[2,53]),{1:[2,1]},{2:12,4:45,6:3,7:4,8:$V0,11:$V1,12:$V2,17:$V3,21:$V4,23:10,24:11,25:$V5,26:$V6,27:$V7,29:$V8,30:$V9,34:$Va,38:$Vb},{2:12,4:46,6:3,7:4,8:$V0,11:$V1,12:$V2,17:$V3,21:$V4,23:10,24:11,25:$V5,26:$V6,27:$V7,29:$V8,30:$V9,34:$Va,38:$Vb},{2:12,4:47,6:3,7:4,8:$V0,11:$V1,12:$V2,17:$V3,21:$V4,23:10,24:11,25:$V5,26:$V6,27:$V7,29:$V8,30:$V9,34:$Va,38:$Vb},{2:12,4:50,6:3,7:4,8:$V0,10:[1,48],11:$V1,12:$V2,15:[1,49],17:$V3,21:$V4,23:10,24:11,25:$V5,26:$V6,27:$V7,29:$V8,30:$V9,34:$Va,38:$Vb},{2:12,4:52,6:3,7:4,8:$V0,10:[1,51],11:$V1,12:$V2,17:$V3,21:$V4,23:10,24:11,25:$V5,26:$V6,27:$V7,29:$V8,30:$V9,34:$Va,38:$Vb},{2:12,4:53,6:3,7:4,8:$V0,11:$V1,12:$V2,17:$V3,21:$V4,23:10,24:11,25:$V5,26:$V6,27:$V7,29:$V8,30:$V9,34:$Va,38:$Vb},{2:12,4:54,6:3,7:4,8:$V0,11:$V1,12:$V2,17:$V3,21:$V4,23:10,24:11,25:$V5,26:$V6,27:$V7,29:$V8,30:$V9,34:$Va,38:$Vb},{2:12,4:55,6:3,7:4,8:$V0,11:$V1,12:$V2,17:$V3,21:$V4,23:10,24:11,25:$V5,26:$V6,27:$V7,29:$V8,30:$V9,34:$Va,38:$Vb},{2:12,4:56,6:3,7:4,8:$V0,11:$V1,12:$V2,17:$V3,21:$V4,23:10,24:11,25:$V5,26:$V6,27:$V7,29:$V8,30:$V9,34:$Va,38:$Vb},{2:12,4:57,6:3,7:4,8:$V0,11:$V1,12:$V2,17:$V3,21:$V4,23:10,24:11,25:$V5,26:$V6,27:$V7,29:$V8,30:$V9,34:$Va,38:$Vb},{34:[1,58]},o($Vo,[2,52]),{9:$Vc,10:$Vd,11:$Ve,13:[1,59],14:$Vf,15:$Vg,16:$Vh,17:$Vi,18:$Vj,19:$Vk,20:$Vl},o($Vp,[2,19],{9:$Vc,18:$Vj,19:$Vk,20:$Vl}),o($Vp,[2,20],{9:$Vc,18:$Vj,19:$Vk,20:$Vl}),{2:12,4:62,6:3,7:4,8:$V0,11:$V1,12:$V2,13:[1,60],17:$V3,21:$V4,22:61,23:10,24:11,25:$V5,26:$V6,27:$V7,29:$V8,30:$V9,31:[1,63],34:$Va,38:$Vb},o($Vm,[2,26]),{34:[1,64]},{34:[1,65]},{30:[1,66]},{25:[1,67],26:[1,68],27:[1,69]},{25:[1,70],26:[1,71],27:[1,72]},{25:[1,73],26:[1,74],27:[1,75]},{29:[1,76]},o($Vm,[2,5]),o([5,10,13,32,33],[2,6],{9:$Vc,11:$Ve,14:$Vf,15:$Vg,16:$Vh,17:$Vi,18:$Vj,19:$Vk,20:$Vl}),o($Vp,[2,7],{9:$Vc,18:$Vj,19:$Vk,20:$Vl}),{2:12,4:77,6:3,7:4,8:$V0,11:$V1,12:$V2,17:$V3,21:$V4,23:10,24:11,25:$V5,26:$V6,27:$V7,29:$V8,30:$V9,34:$Va,38:$Vb},{2:12,4:78,6:3,7:4,8:$V0,11:$V1,12:$V2,17:$V3,21:$V4,23:10,24:11,25:$V5,26:$V6,27:$V7,29:$V8,30:$V9,34:$Va,38:$Vb},o($Vq,[2,14],{9:$Vc,11:$Ve,17:$Vi,18:$Vj,19:$Vk,20:$Vl}),{2:12,4:79,6:3,7:4,8:$V0,11:$V1,12:$V2,17:$V3,21:$V4,23:10,24:11,25:$V5,26:$V6,27:$V7,29:$V8,30:$V9,34:$Va,38:$Vb},o($Vq,[2,13],{9:$Vc,11:$Ve,17:$Vi,18:$Vj,19:$Vk,20:$Vl}),o([5,10,13,16,32,33],[2,12],{9:$Vc,11:$Ve,14:$Vf,15:$Vg,17:$Vi,18:$Vj,19:$Vk,20:$Vl}),o($Vp,[2,15],{9:$Vc,18:$Vj,19:$Vk,20:$Vl}),o($Vr,[2,16],{9:$Vc,20:$Vl}),o($Vr,[2,17],{9:$Vc,20:$Vl}),o([5,10,11,13,14,15,16,17,18,19,20,32,33],[2,18],{9:$Vc}),o($Vn,[2,49]),o($Vm,[2,8]),o($Vm,[2,21]),{13:[1,80],32:[1,81],33:[1,82]},o($Vs,[2,41],{9:$Vc,10:$Vd,11:$Ve,14:$Vf,15:$Vg,16:$Vh,17:$Vi,18:$Vj,19:$Vk,20:$Vl}),o($Vs,[2,42]),o($Vn,[2,46],{28:[1,83]}),o($Vn,[2,47]),o($Vo,[2,51]),o($Vm,[2,30]),o($Vm,[2,31]),o($Vm,[2,32]),o($Vm,[2,33]),o($Vm,[2,34]),o($Vm,[2,35]),o($Vm,[2,36]),o($Vm,[2,37]),o($Vm,[2,38]),{28:[1,84]},o($Vq,[2,9],{9:$Vc,11:$Ve,17:$Vi,18:$Vj,19:$Vk,20:$Vl}),o($Vq,[2,11],{9:$Vc,11:$Ve,17:$Vi,18:$Vj,19:$Vk,20:$Vl}),o($Vq,[2,10],{9:$Vc,11:$Ve,17:$Vi,18:$Vj,19:$Vk,20:$Vl}),o($Vm,[2,22]),{2:12,4:85,6:3,7:4,8:$V0,11:$V1,12:$V2,17:$V3,21:$V4,23:10,24:11,25:$V5,26:$V6,27:$V7,29:$V8,30:$V9,34:$Va,38:$Vb},{2:12,4:86,6:3,7:4,8:$V0,11:$V1,12:$V2,17:$V3,21:$V4,23:10,24:11,25:$V5,26:$V6,27:$V7,29:$V8,30:$V9,34:$Va,38:$Vb},{34:[1,87]},{29:[1,88]},o($Vs,[2,43],{9:$Vc,10:$Vd,11:$Ve,14:$Vf,15:$Vg,16:$Vh,17:$Vi,18:$Vj,19:$Vk,20:$Vl}),o($Vs,[2,44],{9:$Vc,10:$Vd,11:$Ve,14:$Vf,15:$Vg,16:$Vh,17:$Vi,18:$Vj,19:$Vk,20:$Vl}),o($Vn,[2,48]),o($Vm,[2,40],{28:[1,89]}),{30:[1,90]},o($Vm,[2,39])],
...
rules: [/^(?:\s+)/,/^(?:"(\\["]|[^"])*")/,/^(?:'(\\[']|[^'])*')/,/^(?:[A-Za-z]{1,}[A-Za-z_0-9\.]+(?=[(]))/,/^(?:#[A-Z0-9\/]+(!|\?)?)/,/^(?:\$[A-Za-z]+\$[0-9]+)/,/^(?:\$[A-Za-z]+[0-9]+)/,/^(?:[A-Za-z]+\$[0-9]+)/,/^(?:[A-Za-z]+[0-9]+)/,/^(?:[A-Za-z\.]+(?=[(]))/,/^(?:[A-Za-z]{1,}[A-Za-z_0-9]+)/,/^(?:[A-Za-z_]+)/,/^(?:@[A-Za-z_]+)/,/^(?:[0-9]+)/,/^(?:\[(.*)?\])/,/^(?:&)/,/^(?: )/,/^(?:[.])/,/^(?::)/,/^(?:;)/,/^(?:,)/,/^(?:\*)/,/^(?:\/)/,/^(?:-)/,/^(?:\+)/,/^(?:\^)/,/^(?:\()/,/^(?:\))/,/^(?:>)/,/^(?:<)/,/^(?:NOT\b)/,/^(?:")/,/^(?:')/,/^(?:!)/,/^(?:=)/,/^(?:%)/,/^(?:[#])/,/^(?:$)/],
